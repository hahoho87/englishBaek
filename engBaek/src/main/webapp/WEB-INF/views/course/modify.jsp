              ...
              <div class="row">
                    ...
                    <label for="inputClassroom">강의실</label>
				      <select id="search" class="form-control form-control-lg form-control-a" id="inputClassroom" name="classroomNo" multiple="multiple" >     
						...
						<input type="hidden" class="form-control" name="courseCode"
							   readonly="readonly"  value="${course.courseCode}">
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    <label for="inputCourseType">유형</label>
                <select class="form-control form-control-lg form-control-a" 
                		name="courseType" id="selOne" onchange="doChange(this, 'selTwo')">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control form-control-lg form-control-a" 
                ...
                <div class="col-md-12">
                  <button type="submit" data-oper="modify" class="btn btn-a resultBtn">Submit</button>
		...
		$.getJSON("/course/getAttachList", {courseCode:courseCode}, function(arr){
			...
			$(arr).each(function(i, obj){
				...
				str += "<li data-path='" + obj.uploadPath + "' " 			+
						   ...
						   "<div><span>" + obj.coursePictureName + "</span>"			+
					       "    <button type='button' " 					+ 
