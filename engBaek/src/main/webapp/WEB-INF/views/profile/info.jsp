	...
	<div class="panel-body">
		...
		<form role="form" method="post" action="/profile/modify">
			...
			<div class="form-group">
				<label>강사 ID</label> <input class="form-control" name="teacherId" value='${profile.teacherVO.teacherId }' readonly="readonly" >
			</div>
			<div class="form-group">
				<label>과목</label>
				<input type="checkbox" name="teacherSubject" value="toeic 550"> Toeic 550 
				<input type="checkbox" name="teacherSubject" value="toeic 700"> Toeic 700 
				<input type="checkbox" name="teacherSubject" value="toeic 850"> Toeic 850 <br>
				
				<input type="checkbox" name="teacherSubject" value="toeic speacking 5"> Toeic Speaking 5 
				<input type="checkbox" name="teacherSubject" value="toeic speacking 6"> Toeic Speaking 6 
				<input type="checkbox" name="teacherSubject" value="toeic speacking 7"> Toeic Speaking 7 
			</div>
			<div class="form-group">
