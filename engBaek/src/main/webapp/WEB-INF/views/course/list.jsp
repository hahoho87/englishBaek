        ...
        <c:forEach items="${courseList}" var="course">
          <div class="col-md-4">
            <div class="card-box-a card-shadow">
              <div class="img-box-a">
                <img src="/courseImages/display?fileName=${course.uploadPath }/s_${course.coursePictureUuid}_${course.coursePictureName }" 
                    width="100%" height="200px" class="img-d img-fluid">
              </div>
					...
					.change(
							function() {
								...
								if (searchValue == "5" || "6" || "7") {
									...
									actionForm
											.append("<input type='hidden' name='type' value='D'>");
									actionForm
											.append("<input type='hidden' name='keyword' value='"+searchValue+"'>")
								}
								actionForm.attr("action", "/course/list")
