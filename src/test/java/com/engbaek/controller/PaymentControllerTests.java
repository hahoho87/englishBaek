...
//	}
	...
	public void testRegister() throws Exception {
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/payment/payRegister")
											.param("paymentNo", "5")
											.param("courseCode", "1")
											.param("studentId", "stu1")
											.param("paymentMethod", "card")											
											.param("paymentPrice", "100")
											.param("cardType", "card")
											.param("cardNo", "1")
											.param("paymentState", "complete"))
