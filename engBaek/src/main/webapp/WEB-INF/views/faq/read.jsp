...
<form role="form" class="form-a" method="post" action="/faq/modify/">
  ...
  <input type="hidden" name="faqTitle" value="${faq.faqTitle }"> 
  <input type="hidden" name="adminId" value="${faq.adminId }"> 
  <input type="hidden" name="faqContent" value="${faq.faqContent }">
