						...
						<div class="row">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									<label for="inputTeacherId">강사 ID</label> <select
										id="teacherName"
							...
							<div class="col-md-12 mb-3">
								<div class="form-group">
									...
									<div class="grid-option">
										<input type="checkbox" name="teacherSubject" value="토익-550">토익-550&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="teacherSubject" value="토익-700">토익-700&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="teacherSubject" value="토익-850">토익-850&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="teacherSubject" value="토스-5">토스-5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="teacherSubject" value="토스-6">토스-6&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="teacherSubject" value="토스-7">토스-7&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									</div>
								</div>
							</div>
		...
		$("button[type='submit']").on("click", function(e) {
			...
			$(".uploadResult ul li").each(function(i, obj){
				...
				str += "<input type='hidden' " + 
		   		  	    "name='attachList["+i+"].teacherProfilePicture' " + 
		   		  		"value='"+jobj.data("filename")+"'>";
				str += "<input type='hidden' " + 
				   		  "name='attachList["+i+"].teacherProfileUuid' " + 
			...
			function showUploadResult(uploadResultArr){
				...
				$(uploadResultArr).each(function(i, obj){
					...
					if(obj.fileType){	//이미지인 경우
						...
						var fileCallPath = encodeURIComponent(obj.uploadPath + "/" + obj.teacherProfileUuid  + "_" +
