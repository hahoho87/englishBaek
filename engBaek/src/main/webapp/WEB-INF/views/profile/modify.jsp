							...
							<div class="col-md-6 mb-3">
								<div class="form-group">
									<label for="inputTeacherId">강사 ID</label> <select
										...
										name="teacherId" >
										<option value="${profile.teacherId}" >${profile.teacherVO.name}(${profile.teacherVO.teacherId })</option>
		...
		$.getJSON("/profile/getAttachList", {teacherPno:teacherPno}, function(arr){
			...
			$(arr).each(function(i, obj){
				...
				str += "<li data-path='" + obj.uploadPath + "' " 			+
						   ...
						   "<div><span>" + obj.teacherProfilePicture + "</span>"			+
					       "    <button type='button' " 					+ 
