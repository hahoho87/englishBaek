              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    <label for="noticeNo">작성자</label> <input type="text" name="adminId" class="form-control form-control-lg form-control-a" id="adminId" value="<sec:authentication property="principal.username"/>" readonly="readonly">
                  </div>
                </div>
                <div class="col-md-12 mb-3">
                  <div class="form-group">
                    <label for="noticeTitle">제목</label> <input type="text" name="noticeTitle" class="form-control form-control-lg form-control-a" id="noticeTitle" value="${notice.noticeTitle }" required>
                  </div>
                </div>
	...
	$(function() {
		...
		$('button').on("click",function(e) {
    		...
    		if (operation === 'cancel') {
    			...
    			formObj.attr("action", "/notice/modify").attr("method",
    					"post");
    			...
    			formObj.attr("action", "/notice/read").attr("method",
    					"get");
    			;
