            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-3">
                <div class="form-group">
                  ...
                  <textarea id="infoInput" class="form-control" placeholder="강사 정보 *" name="teacherProfile" 
              ...
              <div class="col-md-12 mb-3">
                <div class="form-group">
                  ...
                  <div class="grid-option">
                    <input type="checkbox" name="teacherSubject" value="토익-550">토익-550&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox" name="teacherSubject" value="토익-700">토익-700&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox" name="teacherSubject" value="토익-850">토익-850&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox" name="teacherSubject" value="토스-5">토스-5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox" name="teacherSubject" value="토스-6">토스-6&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox" name="teacherSubject" value="토스-7">토스-7&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </div>
                </div>
              </div>
			...
			.ready(
					function(e) {
						...
						str += "><div>";
																		...
																		str += "<img src='/profileImages/display?fileName="
																				+ fileCallPath
																				+ "'>";
																		str += "</div></li>"
																		console
